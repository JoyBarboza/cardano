...
class MarketPlaceController extends Controller
{
    ...
    public function user_nft()
    {
        ...
        return view('market_place.user_nft',compact('nft'));
    }
     ...
     public function nft_detail($id)
    {
        ...
        return view('market_place.nft_detail',compact('nft_detail'));
    }
    ...
    public function mynfT()
    {
        ...
        return view('market_place.my_nft',compact('my_nft'));
    }
    ...
    public function mynfT_detail($id)
    {
        ...
        return view('market_place.mynfT_detail',compact('nft_detail'));
    }
